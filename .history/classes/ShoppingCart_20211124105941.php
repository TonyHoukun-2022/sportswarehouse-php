<?php
  ...
  class ShoppingCart { 
    ...
    //save cart
    public function saveCart($Address, $contactNumber, $creditCardNumber, $email, $expiryDate, $firstName, $lastName, $nameOnCard) {
      ...
      $sql = "INSERT INTO shoppingOrder(Address, contactNumber, creditCardNumber, csv, email, expiryDate, firstName, lastName, nameOnCard, OrderDate) VALUES(:Address, :contactNumber, :creditCardNumber,  :email, :expiryDate, :firstName, :lastName, :nameOnCard, curdate())";
