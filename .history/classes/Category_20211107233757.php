...
class Category {
  ...
  public function getCategories() {
   ...
   public function addCategory() {
    ...
    // set up SQL
    $sql = "INSERT INTO category (categoryId, categoryName) VALUES(:categoryId, :categorName)";
    $stmt = $pdo->prepare($sql);
    $stmt->bindValue(":categoryId", $_POST["newCategoryId"], PDO::PARAM_INT);
    $stmt->bindValue(":categorName", $_POST["newCategoryName"], PDO::PARAM_STR);
